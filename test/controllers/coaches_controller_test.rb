...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { company: @coach.company, email: @coach.email, field: @coach.field, name: @coach.name }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { company: @coach.company, email: @coach.email, field: @coach.field, name: @coach.name }
    assert_redirected_to coach_path(assigns(:coach))
  end
